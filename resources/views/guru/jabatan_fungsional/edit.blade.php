    ...
    <section class="panel" style="margin-bottom:20px;">
        ...
        <div class="panel-body" style="border-top: 1px solid #eee; padding:15px; background:white;">
            <div class="row" style="margin-right:-15px; margin-left:-15px;">
                ...
                <div class="row">
                    <form action="{{ route('guru.jabatan_fungsional.update',[$data->jfNoUrt]) }}" enctype="multipart/form-data" method="POST">
                        {{ csrf_field() }} {{ method_field('PATCH') }}
                        <div class="col-md-12">
                            {{--  <div class="form-group col-md-6">
                                <label for="exampleInputEmail1">Jenis Jabatan</label>
                                <input type="text" value="{{ $data->jfKdJenisjab }}" name="jfKdJenisjab" class="tags form-control @error('jfKdJenisjab') is-invalid @enderror" />
                                <div>
                           ...
                           <div class="form-group col-md-6">
                                ...
                                <input type="date" value="{{ $data->jfTmtJab }}" name="jfTmtJab" class="tags form-control @error('jfTmtJab') is-invalid @enderror" />
                                <div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" value="{{ $data->jfNoSk }}" name="jfNoSk" class="tags form-control @error('jfNoSk') is-invalid @enderror" />
                                <div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="date" value="{{ $data->jfTglSk }}" name="jfTglSk" class="tags form-control @error('jfTglSk') is-invalid @enderror" />
                                <div>
                            ...
                            {{--  <div class="form-group col-md-6">
                                ...
                                <input type="text" value="{{ $data->jfPejabat }}" name="jfPejabat" class="tags form-control @error('jfPejabat') is-invalid @enderror" />
                                <div>
