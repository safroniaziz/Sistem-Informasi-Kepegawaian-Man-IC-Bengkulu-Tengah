                    ...
                    <form action="{{ route('guru.kepangkatan.post') }}" enctype="multipart/form-data" method="POST">
                        ...
                        <div class="col-md-12">
                            <div class="form-group col-md-6">
                                ...
                                <select name="goGol" class="form-control" id="">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="goMaskertnh" class="tags form-control @error('goMaskertnh') is-invalid @enderror" />
                                @if ($errors->has('goMaskertnh'))
                                    <small class="form-text text-danger">{{ $errors->first('goMaskertnh') }}</small>
                                @endif
                            </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="goPejabat" class="tags form-control @error('goPejabat') is-invalid @enderror" />
                                @if ($errors->has('goPejabat'))
                                    <small class="form-text text-danger">{{ $errors->first('goPejabat') }}</small>
                                @endif
                            </div>
